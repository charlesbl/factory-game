...
export interface WorldBuildingDefinition {
  readonly id: string;
  readonly kind: 'mine' | 'storage' | 'depot';
  readonly name: string;
  readonly footprint: GridSize;
  readonly buildCost: readonly ItemQuantity[];
}
export interface WorldContent {
  ...
  readonly componentBuildCosts: Readonly<
    Record<
      'external-input' | 'external-output' | 'junction',
...
export const resourceColour = (index: number): string =>
