...
const machineCrafts = {
    ...
    ironPlating: new Craft("Iron Plating", [new ItemStack(items.ironIngot, 10), new ItemStack(items.copperIngot, 10)], crafts.ironIngot, 5000),
...
class Game {
    constructor() {
        ...
        factory.buildMachine(crafts.ironOre);
        factory.buildMachine(crafts.ironIngot);
        factory.buildMachine(crafts.ironPlate);
