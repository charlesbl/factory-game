...
class MachineView extends React.Component {
    render() {
        var craftBtn = this.props.machine.manual ? <button onClick={() => this.props.machine.manualUpdate()} className="btn btn-warning btn-side"><i class="fas fa-hammer fa-xs"></i></button> : "";
